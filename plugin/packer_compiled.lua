...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/tai/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nvim-comment"] = {
    loaded = true,
    path = "/home/tai/.local/share/nvim/site/pack/packer/start/nvim-comment",
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/home/tai/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/tai/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["staline.nvim"] = {
    loaded = true,
    path = "/home/tai/.local/share/nvim/site/pack/packer/start/staline.nvim",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/tai/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
